...
public class RenderSurfaceView extends GLSurfaceView {
	...
	public ConfigChooser getConfigChooser() throws IllegalStateException {
		if (this.mConfigChooser == null) {
			throw new IllegalStateException(ConfigChooser.class.getSimpleName()
					+ " not yet set.");
		}
	...
	public void setMeasuredDimensionProxy(final int pMeasuredWidth,
			final int pMeasuredHeight) {
	...
	public void setRenderer(final Engine pEngine,
		...
		if (this.mConfigChooser == null) {
			final boolean multiSampling = pEngine.getEngineOptions()
		...
		this.mEngineRenderer = new EngineRenderer(pEngine, this.mConfigChooser,
				pRendererListener);
