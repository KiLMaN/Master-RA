...
public class TextureRegion extends BaseTextureRegion {
	...
	public TextureRegion(final ITexture pTexture, final float pTextureX,
			final float pTextureY, final float pTextureWidth,
			final float pTextureHeight) {
		this(pTexture, pTextureX, pTextureY, pTextureWidth, pTextureHeight,
				false);
	}
	...
	public TextureRegion deepCopy() {
		if (this.mRotated) {
			return new TextureRegion(this.mTexture, this.mTextureX,
					this.mTextureY, this.mTextureHeight, this.mTextureWidth,
					this.mScale, this.mRotated);
		} else {
			return new TextureRegion(this.mTexture, this.mTextureX,
					this.mTextureY, this.mTextureWidth, this.mTextureHeight,
					this.mScale, this.mRotated);
		}
	}
	...
	@Override
	public void setTextureSize(final float pTextureWidth,
			final float pTextureHeight) {
		this.mTextureWidth = pTextureWidth;
		this.mTextureHeight = pTextureHeight;
	...
	@Override
	public void set(final float pTextureX, final float pTextureY,
	...
	public void updateTexture(ITexture pTexture) {
