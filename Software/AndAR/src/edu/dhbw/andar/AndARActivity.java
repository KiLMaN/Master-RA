...
public abstract class AndARActivity extends Activity implements Callback,
	...
	/**
	 * Set a renderer that draws non AR stuff. Optional, may be set to null or
	 * omited. and setups lighting stuff.
	 * 
	...
	/**
	 * Open the camera and start detecting markers. note: You must assure that
	 * the preview surface already exists!
	 */
	...
	/**
	 * Take a screenshot. Must not be called from the GUI thread, e.g. from
	 * methods like onCreateOptionsMenu and onOptionsItemSelected. You have to
	 * use a asynctask for this purpose.
	 * 
