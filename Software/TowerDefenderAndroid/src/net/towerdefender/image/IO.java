...
public class IO {
	...
	/**
	 * transfers required files to the the private file system part in order to
	 * be access them from C Code. required, as you can not access the files of
	 * the apk package directly
	 */
	public static void transferFilesToPrivateFS(File base, Resources res)
			throws IOException {
		...
		if (base.exists()) {
			...
			if (!cameraFile.exists()) {
				copy(am.open("camera_para.dat"), new FileOutputStream(
						cameraFile));
			}
		}
	}
