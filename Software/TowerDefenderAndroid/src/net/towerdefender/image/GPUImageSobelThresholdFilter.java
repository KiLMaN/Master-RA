 ...
 * 
 * private int mUniformThresholdLocation; private float mThreshold = 0.9f;
 * 
 * public GPUImageSobelThresholdFilter() { this(0.6f); }
 * 
 * public GPUImageSobelThresholdFilter(float threshold) {
 * super(SOBEL_THRESHOLD_EDGE_DETECTION); mThreshold = threshold; }
 * 
